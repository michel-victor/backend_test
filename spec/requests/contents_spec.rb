...
RSpec.describe "/contents", type: :request do
  ...
  # ContentsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get contents_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Content" do
        expect {
          post contents_url,
               params: { content: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Content" do
        expect {
          post contents_url,
               params: { content: invalid_attributes }, as: :json
        }.to change(Content, :count).by(0)
      end

      it "renders a JSON response with errors for the new content" do
        post contents_url,
             params: { content: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested content" do
        ...
        patch content_url(content),
              params: { content: new_attributes }, headers: valid_headers, as: :json
        content.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested content" do
      content = Content.create! valid_attributes
      expect {
        delete content_url(content), headers: valid_headers, as: :json
      }.to change(Content, :count).by(-1)
    end
  end
end
